...
model_defaults["weibull"] = {"alpha": .7,
                             "beta": 0.1,
                             "kappa": 0.01,
                             "delta": 1}
...
model_defaults["janoschek"] = {"a": 0.73,
                               "beta": 0.07,
                               "k": 0.355,
                               "delta": 0.46}
...
def gompertz(x, a, b, c):
    """
        ...
        b sets the displacement along the x axis (translates the graph to the
          left or right)
