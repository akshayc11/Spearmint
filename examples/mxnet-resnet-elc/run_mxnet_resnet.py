...
train_cmd ='python train_cifar10_custom.py --gpus 0 --units {} --filter-list {} --lr {} --lr-factor {} --lr-step-epoch {} --kill-time 0'
out_dir='/data-local2/akshayc/Workspace/Software/Spearmint-global/examples/mxnet-resnet-elc/log'
